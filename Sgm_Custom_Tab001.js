...
define(["qlik", "jquery",
    ...
    function(qlik, $, $q, DataTables, FixedColumns, iscroll, columnWidth) {
        'use strict';
        var tablsInit = null;
        var initHeight = 0;
        var initWidth = 0;

        function createRows(rows, dimensionInfo, sgmTableStyle) {
        ...
        return {
            ...
            paint: function($element, layout) {
                ...
                //render data
                html += createRows(hypercube.qDataPages[0].qMatrix, hypercube.qDimensionInfo, sgmTableStyle);
